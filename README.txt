...
* To use MINTmap, you need to have python3 (https://www.python.org/downloads) installed.

* Download the latest MINTmap from (https://cm.jefferson.edu/MINTmap) and then uncompress the contents.
