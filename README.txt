...
You can contact us at cmcadmins@jefferson.edu
...
4. Installation using Anaconda
------------------------------

1. Download the Anaconda Installer (https://www.anaconda.com/products/individual#Downloads)

Note: If you are using Mac or Windows, download the **graphical** Anaconda
Installer. Also, the minimum recommended Anaconda version is 4.6.
...
6. 6. Generate tRF profiles using the example (included in MINTmap download) trimmed fastq file by running:
